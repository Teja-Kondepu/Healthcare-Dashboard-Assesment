...
// Simulate the current selected page; in a real app, this would come from router or props
const selectedLabel = "Dashboard";
      ...
      <nav className={styles.nav}>
        {navigationLinks
          ...
          .map(link => (
            <div
              className={
                `${styles.navItem} ${link.label === selectedLabel ? styles.navItemActive : ""}`
              }
              key={link.label}
            >
